...
public abstract class AbsBYDAutoBigDataListener implements android.hardware.IBYDAutoListener {
    protected static final String TAG = "AbsBYDAutoBigDataListener";

    public AbsBYDAutoBigDataListener() { throw new RuntimeException("Stub!"); }
