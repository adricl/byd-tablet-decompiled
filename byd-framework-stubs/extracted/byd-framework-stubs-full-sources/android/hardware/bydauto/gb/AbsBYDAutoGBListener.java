...
public abstract class AbsBYDAutoGBListener implements android.hardware.IBYDAutoListener {
    ...
    @Deprecated
    public void onNeedRendRegisterTable(int value) { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public void onTempMeterPercentAlarmChanged(int value) { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public void onWholeFrameDataChanged(byte[] data) { throw new RuntimeException("Stub!"); }
}
