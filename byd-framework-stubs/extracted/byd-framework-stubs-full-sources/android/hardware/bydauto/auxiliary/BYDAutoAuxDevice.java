...
public final class BYDAutoAuxDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    /**
     * Reads feature ID {@code AUX_CONNECT_STATE} (0x0005afdc).
     ...
     */
    @Deprecated
    public int getAuxConnectStatus() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code AUX_SIGNAL_STATE} (0x0004a222).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getAuxSignalStatus() { throw new RuntimeException("Stub!"); }
