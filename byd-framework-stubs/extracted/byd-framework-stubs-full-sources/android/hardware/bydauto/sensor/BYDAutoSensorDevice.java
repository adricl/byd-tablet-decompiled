...
public final class BYDAutoSensorDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    /**
     * Reads feature ID {@code SENSOR_HUMIDITY} (0x000b4cd7).
     ...
     */
    @Deprecated
    public double getHumiditySensorValue() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code SENSOR_AX_STATUS_223} (0x2230003f), {@code SENSOR_AX_223} (0x22300008), {@code SENSOR_AX_OFFSET_223} (0x22300014) [direct + via getSensorAxValue()].
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public byte[] getSensorAxValue() { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    protected int getSensorAxValue(int flag) { throw new RuntimeException("Stub!"); }
    public String getSetPermission() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code SENSOR_AUTO_SLOPE} (0x2230002c).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getSlope() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code SENSOR_TEMPERATURE} (0x000c2697).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public double getTemperatureSensorValue() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Writes feature ID {@code SENSOR_G_SENSOR_OR_ANGLE_SET} (0x42600008).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setOrientationAngle(int value) { throw new RuntimeException("Stub!"); }
