...
public abstract class AbsBYDAutoRSEListener implements android.hardware.IBYDAutoListener {
    protected static final String TAG = "AbsBYDAutoRSEListener";

    public AbsBYDAutoRSEListener() { throw new RuntimeException("Stub!"); }
    ...
    @Deprecated
    public void onAudioRequestFromRseChanged(int source, int state) { throw new RuntimeException("Stub!"); }
    ...
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public void onWriteFeedbackFromRseChanged(int source, int item, int state) { throw new RuntimeException("Stub!"); }
}
