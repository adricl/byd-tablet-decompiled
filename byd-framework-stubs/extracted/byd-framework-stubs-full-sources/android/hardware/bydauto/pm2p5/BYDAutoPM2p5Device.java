...
public final class BYDAutoPM2p5Device extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    /**
     * Reads feature ID {@code PM25_ANION_STATE} (0x3da00016).
     ...
     */
    @Deprecated
    public int getPM2p5AnionState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code PM25_DUAL_CHANNEL_DETECT_STATE} (0x4f600039).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getPM2p5DualChannelDetectState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code PM2P5_WARNING_INFO} (0x4f60002c).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getPM2p5WarningInfo() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code PM2P5_PROMPT_INFO} (0x4f60002c).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getPromptInfo() { throw new RuntimeException("Stub!"); }
    public String getSetPermission() { throw new RuntimeException("Stub!"); }
    public int getType() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code PM25_DUAL_CHANNEL_DETECT_CONFIG} (0x4f600036), {@code PM25_ANION_CONFIG} (0x43300025).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    ...
    /**
     * Writes feature ID {@code PM25_ANION_STATE_SET} (0x4fc00012).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPM2p5AnionDetectState(int state) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PM25_DUAL_CHANNEL_DETECT_STATE_SET} (0x4f50001a).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPM2p5DualChannelDetectState(int state) { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public int syncPM2p5AllStatus() { throw new RuntimeException("Stub!"); }
