...
public final class BYDAutoGearboxDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    /**
     * Reads feature ID {@code GEARBOX_TYPE} (0x40d00020), {@code GEARBOX_PARK_BRAKE_SWITCH} (0x05500030), {@code GEARBOX_MANUAL_MODE_LEVEL} (0x29400020), {@code GEARBOX_AUTO_MODE_TYPE} (0x21200038) [via isGearboxAuto(), getParkBrakeSwitch(), getGearboxManualModeLevel(), getGearboxAutoModeType()].
     ...
     */
    @Deprecated
    public int getCurrentGear() { throw new RuntimeException("Stub!"); }
    public int getDevicetype() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code GEARBOX_EPB_STATE} (0x21800011).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getEPBState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code GEARBOX_PARK_BRAKE_SWITCH} (0x05500030) [via getParkBrakeSwitch()].
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getGearboxState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code GEARBOX_TYPE} (0x40d00020), {@code GEARBOX_MANUAL_MODE_LEVEL} (0x29400020), {@code GEARBOX_AUTO_MODE_TYPE} (0x21200038).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public boolean isInReverseGear() { throw new RuntimeException("Stub!"); }
