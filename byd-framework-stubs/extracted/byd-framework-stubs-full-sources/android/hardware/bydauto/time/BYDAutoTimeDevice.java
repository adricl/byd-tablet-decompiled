...
public final class BYDAutoTimeDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    /**
     * Reads feature ID {@code TIME_DATE_FORMAT} (0x49c0000e).
     ...
     */
    @Deprecated
    public int getDateFormat() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code TIME_SUMMERTIME_STATE} (0x49c00010).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getSummertimeState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code TIME_ZONE} (0x0000b6e7).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getTimeZone() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Writes feature ID {@code TIME_DATE_FLAG_SET} (0x4df00039), {@code TIME_SET_MODE_SET} (0x4df00038), {@code TIME_YEAR_SET} (0x4df00008), {@code TIME_MONTH_SET} (0x4df00010), {@code TIME_DAY_SET} (0x4df00018), {@code TIME_WEEKDAY_SET} (0x4df0003c), {@code TIME_HOUR_SET} (0x4df00020), {@code TIME_MINUTE_SET} (0x4df00028), {@code TIME_SECOND_SET} (0x4df00030), {@code TIME_DATE_FLAG_2_SET} (0x13600039), {@code TIME_SET_MODE_2_SET} (0x13600038), {@code TIME_YEAR_2_SET} (0x13600008), {@code TIME_MONTH_2_SET} (0x13600010), {@code TIME_DAY_2_SET} (0x13600018), {@code TIME_WEEK_2_SET} (0x1360003c), {@code TIME_HOUR_2_SET} (0x13600020), {@code TIME_MINUTE_2_SET} (0x13600028), {@code TIME_SECOND_2_SET} (0x13600030).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setFullTime(int mode, int year, int month, int day, int weekday, int hour, int minute, int second) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code TIME_DATE_FLAG_SET} (0x4df00039), {@code TIME_SET_MODE_SET} (0x4df00038), {@code TIME_YEAR_SET} (0x4df00008), {@code TIME_MONTH_SET} (0x4df00010), {@code TIME_DAY_SET} (0x4df00018), {@code TIME_HOUR_SET} (0x4df00020), {@code TIME_MINUTE_SET} (0x4df00028), {@code TIME_SECOND_SET} (0x4df00030).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setFullTimeToECM(int year, int month, int day, int hour, int minute, int second) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code TIME_YEAR_2B6_SET} (0x2b600008), {@code TIME_MONTH_2B6_SET} (0x2b600010), {@code TIME_DAY_2B6_SET} (0x2b600018), {@code TIME_HOUR_2B6_SET} (0x2b600020), {@code TIME_MINUTE_2B6_SET} (0x2b600028), {@code TIME_SECOND_2B6_SET} (0x2b600030), {@code TIME_WEEKDAY_2B6_SET} (0x2b600038), {@code TIME_FORMAT_2B6_SET} (0x2b60003b).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setFullTimeWithTimeFormat(int year, int month, int day, int hour, int minute, int second, int weekday, int timeFormat) { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Writes feature ID {@code TIME_ZONE_SET} (0x0007e2fe).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setTimeZone(int value) { throw new RuntimeException("Stub!"); }
