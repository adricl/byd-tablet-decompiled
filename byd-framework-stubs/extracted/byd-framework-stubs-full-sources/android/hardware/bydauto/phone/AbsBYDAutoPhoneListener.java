...
public abstract class AbsBYDAutoPhoneListener implements android.hardware.IBYDAutoListener {
    protected static final String TAG = "AbsBYDAutoPhoneListener";

    public AbsBYDAutoPhoneListener() { throw new RuntimeException("Stub!"); }
    ...
    @Deprecated
    public void onPhoneEventChanged(int state) { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public void onPhoneMuteChanged(int state) { throw new RuntimeException("Stub!"); }
}
