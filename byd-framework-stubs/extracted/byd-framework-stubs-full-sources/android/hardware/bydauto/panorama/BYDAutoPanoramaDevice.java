...
public class BYDAutoPanoramaDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    /**
     * Reads feature ID {@code PANORAMA_ACU_STATE} (0x000cbf67).
     ...
     */
    @Deprecated
    public int getACUState() { throw new RuntimeException("Stub!"); }
    /** Reads feature ID {@code PANORAMA_BACK_LINE_CONFIG} (0x4f401020). */
    public int getBackLineConfig() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code PANORAMA_CAR_BODY_STATE} (0x4f401028).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getCarInfo() { throw new RuntimeException("Stub!"); }
    public int getDevicetype() { throw new RuntimeException("Stub!"); }
    /** Reads feature ID {@code PANORAMA_WORK_MODE} (0x4f401014). */
    public int getDisplayMode() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code PANORAMA_EMERGENCY_BUTTON_STATE} (0x33700008).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getEmergencyButtonState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code PANORAMA_LVDS_STATE} (0x4f401022).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getLVDSState() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code PANORAMA_APA_STATE} (0x13400008).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getPanoAPAState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code PANORAMA_REMOTE_CALL_SUPPORT} (0x4f40102c).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getPanoRemoteImageCallSupport() { throw new RuntimeException("Stub!"); }
    /** Reads feature ID {@code PANORAMA_ROTATION} (0x4f40101c). */
    public int getPanoRotation() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code PANORAMA_APA_TRANSPARENT_SWITCH} (0x4f40101e).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getPanoTransparence() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code PANORAMA_RINGHT_CAMERA_SWITCH} (0x40c0101e).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getRFCameraSwitchState() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code PANORAMA_RINGHT_CAMERA_SWITCH} (0x40c0101e).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getRightCameraSwitchState() { throw new RuntimeException("Stub!"); }
    public String getSetPermission() { throw new RuntimeException("Stub!"); }
    public int getType() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code ONLINE_HAS_0x033700} (0x33700000), {@code PANORAMA_HAS_ACU} (0x33700000).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    ...
    /**
     * Writes feature ID {@code PANORAMA_APA_AVM_MODE} (0x4de01046).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setAPAAvmMode(int mode) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_APA_TRANSPARENT_SWITCH_SET} (0x4de01040).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setAPATransparentSwitch() { throw new RuntimeException("Stub!"); }
    public void setAllStatus() { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_WORK_MODE_SET} (0x4de01014).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setDisplayMode(int mode) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_LVDS_STATE_SET} (0x4f500040).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setLVDSState(int state) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_FOCUS_SET} (0x000bbf94).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoFocusState(int state) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_OPERATION_SET} (0x0002c2f3).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoOperation(int operation) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_OUTPUT_STATE_SET} (0x4de01010).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoOutputState(int value) { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Writes feature ID {@code PANORAMA_OUTPUT_STATE_SET} (0x4de01010), {@code PANORAMA_WORK_MODE_SET} (0x4de01014), {@code PANORAMA_ROTATION_SET} (0x4de01022), {@code PANORAMA_APA_OUTPUT_STATUS} (0x4de01024).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoParams(int output, int mode, int rotation, int apaMode) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_OUTPUT_STATE_SET} (0x4de01010), {@code PANORAMA_WORK_MODE_SET} (0x4de01014), {@code PANORAMA_ROTATION_SET} (0x4de01022), {@code PANORAMA_APA_OUTPUT_STATUS} (0x4de01024), {@code PANORAMA_APA_OUTPUT_STATUS2} (0x4de01028).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoParams(int output, int mode, int rotation, int apaMode, int apaMode2) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_REMOTE_CALL} (0x4de01042).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoRemoteCall(int value) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_ROTATION_SET} (0x4de01022).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoRotation(int value) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_SET_TOUCH_X_SET} (0x3ec00008), {@code PANORAMA_SET_TOUCH_Y_SET} (0x3ec00018), {@code PANORAMA_SET_PRESS_ACTION_SET} (0x3ec00016), {@code PANORAMA_SET_RESOLUTION_WIDE_SET} (0x3ec00028), {@code PANORAMA_SET_RESOLUTION_HIGH_SET} (0x3ec00038).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoTouchCoordinateAndShowArea(double x, double y, int operate, double width, double height) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_TRANSPARENCE_SWITCH_SET} (0xaa000048).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setPanoramaTransparence(int state) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code PANORAMA_RINGHT_CAMERA_SWITCH_SET} (0x1e000017).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setRFCameraSwitchState(int state) { throw new RuntimeException("Stub!"); }
