...
public final class BYDAutoTyreDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    /**
     * Reads feature ID {@code TYRE_INDITECT_TYRE_SYSTEM_STATE} (0x4170000e).
     ...
     */
    @Deprecated
    public int getIndirectTyreSystemState() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code TYRE_BATTERY_VALUE_LEFT_FRONT} (0x000f2de3), {@code TYRE_BATTERY_VALUE_RIGHT_FRONT} (0x0006af1b), {@code TYRE_BATTERY_VALUE_LEFT_REAR} (0x0005a68b), {@code TYRE_BATTERY_VALUE_RIGHT_REAR} (0x0001d3e7).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public double getTyreBatteryValue(int area) { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code TYRE_HAS_TYRE_PRESSURE_ONLINE} (0x3cd00000), {@code TYRE_HAS_TYRE_INDIRECT_PRESSURE_DISPLAY_ONLINE} (0x4bf00044), {@code TYRE_HAS_INDIRECT_TYRE_PRESSURE_ONLINE} (0x41700010).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    ...
    /**
     * Writes feature ID {@code TYRE_INDIRECT_TYRE_SYSTEM_CONFIRM_SET} (0x38500034).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setIndirectTyreConfirm(int value) { throw new RuntimeException("Stub!"); }
