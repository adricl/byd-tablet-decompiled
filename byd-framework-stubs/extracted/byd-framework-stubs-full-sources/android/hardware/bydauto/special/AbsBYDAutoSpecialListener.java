...
public abstract class AbsBYDAutoSpecialListener implements android.hardware.IBYDAutoListener {
    protected static final String TAG = "AbsBYDAutoSpecialListener";

    public AbsBYDAutoSpecialListener() { throw new RuntimeException("Stub!"); }
    ...
    @Deprecated
    public void onWheelDirectionChanged(byte[] direction) { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public void onWheelSpeedChanged(byte[] speed) { throw new RuntimeException("Stub!"); }
}
