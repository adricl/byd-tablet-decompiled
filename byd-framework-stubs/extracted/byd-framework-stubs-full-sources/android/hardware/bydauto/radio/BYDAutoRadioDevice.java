...
public final class BYDAutoRadioDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    @Deprecated
    public int autoSearch() { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public int cancelAutoSearch() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code RADIO_CURRENT_FREQ} (0x330a2020), {@code RADIO_PLAY_FREQ} (0x330a2020).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getCurFreq() { throw new RuntimeException("Stub!"); }
    ...
    /**
     * Reads feature ID {@code RADIO_CURRENT_STATUS} (0x330a2010), {@code RADIO_PLAY_BAND} (0x330a2010).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getRadioBand() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code RADIO_FM_INIT_STARTFREQ} (0x330a0010), {@code RADIO_FM_INIT_ENDFREQ} (0x330a0020), {@code RADIO_FM_INIT_STEP} (0x330a0030), {@code RADIO_AM_INIT_STARTFREQ} (0x330a1010), {@code RADIO_AM_INIT_ENDFREQ} (0x330a1020), {@code RADIO_AM_INIT_STEP} (0x330a1030).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int[] getRadioParam(int band) { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code RADIO_CURRENT_STATUS} (0x330a2010), {@code RADIO_PLAY_BAND} (0x330a2010).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getRadioState() { throw new RuntimeException("Stub!"); }
    /**
     * Reads feature ID {@code RADIO_SEARCH_STATUS} (0x330aa010).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int getSearchProcessState() { throw new RuntimeException("Stub!"); }
    ...
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public int radioOff() { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public int radioOn() { throw new RuntimeException("Stub!"); }
    ...
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public int seek(boolean next) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code RADIO_PLAY_BAND_SET} (0x4e0a2010), {@code RADIO_PLAY_FREQ_SET} (0x4e0a2020).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setCurFreq(int band, int frequency) { throw new RuntimeException("Stub!"); }
    /**
     * Writes feature ID {@code RADIO_FM_INIT_STARTFREQ_SET} (0x4e0a0010), {@code RADIO_FM_INIT_ENDFREQ_SET} (0x4e0a0020), {@code RADIO_FM_INIT_STEP_SET} (0x4e0a0030), {@code RADIO_AM_INIT_STARTFREQ_SET} (0x4e0a1010), {@code RADIO_AM_INIT_ENDFREQ_SET} (0x4e0a1020), {@code RADIO_AM_INIT_STEP_SET} (0x4e0a1030).
     * <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it.
     */
    @Deprecated
    public int setRadioParam(int band, int start, int end, int step) { throw new RuntimeException("Stub!"); }
