...
public final class BYDAutoVehicleDataDevice extends android.hardware.bydauto.AbsBYDAutoDevice {
    ...
    @Deprecated
    public int sendRegisterTable(int type, byte[] table) { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public int sendVehicleDataAcq(byte[] vehicleData) { throw new RuntimeException("Stub!"); }
    /** <b>Hidden API (blacklist):</b> normal apps get NoSuchMethodError / NoSuchFieldError; only system/platform apps, or a device with hidden_api_policy relaxed, can use it. */
    @Deprecated
    public int sendWholeFrameData(byte[] vehicleData) { throw new RuntimeException("Stub!"); }
